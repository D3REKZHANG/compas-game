...
const Intro = ({ setGamestate }) => {
  ...
  return (
    <div>
      ...
      {(state == 1) && <>
      <p>
Review each case and give the defendant a score between 1 and 10 based on how likely it is you think they’ll reoffend. A rating between 1-4 signals a low risk of reoffense, while 5-7 indicates moderate risk, and 8-10 high risk. You will be timed, so act decisively!
        </p>
        <p>
