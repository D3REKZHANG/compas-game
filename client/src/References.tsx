  ...
  return (
    <div>
      ...
      <p className="references">
        ...
        <span class="reference">Angwin, J., Larson, J., Mattu, S., & Kirchner, L. (2016, May 23). Machine Bias: There’s software used across the country to predict future criminals. And it’s biased against blacks. <i>ProPublica.</i> Retrieved from 
        ...
        <span class="reference">Dodd, M. A. (2016). Perceptions of factors related to recidivism and recovery. <i>California State University, Fresno, College of Health and Human Services.</i> Retrieved from 
        ...
        <span class="reference">Engel, C., Linhardt, L., & Schubert, M. (2024). Code is law: How COMPAS affects the way the judiciary handles the risk of recidivism. <i>Artificial Intelligence and Law.</i> 
          <a href="https://doi.org/10.1007/s10506-024-09389-8" target="_blank">https://doi.org/10.1007/s10506-024-09389-8</a></span><br />

        <span class="reference">Equal Justice Initiative. (2019). Risk assessment tool led to harsher sentences for young or Black defendants. Retrieved from 
        ...
        <span class="reference">Flores, A. W., Bechtel, K., & Lowenkamp, C. T. (2016). False positives, false negatives, and false analyses: A rejoinder to “Machine bias: There’s software used across the country to predict future criminals. And it’s biased against blacks.” <i>Federal Sentencing Reporter, 28</i>(1), 1-13. 
          <a href="https://doi.org/10.1525/fsr.2016.28.1.1" target="_blank">https://doi.org/10.1525/fsr.2016.28.1.1</a></span><br />

        <span class="reference">Ji, Z., Chen, D., Ishii, E., Cahyawijaya, S., Bang, Y., Wilie, B., & Fung, P. (2024). LLM internal states reveal hallucination risk faced with a query. In <i>Proceedings of the 7th BlackboxNLP Workshop: Analyzing and Interpreting Neural Networks for NLP</i> (pp. 88–104). Miami, Florida, US: Association for Computational Linguistics.</span><br />

        <span class="reference">Larson, J., Mattu, S., Kirchner, L., & Angwin, J. (2016, May 23). How we analyzed the COMPAS recidivism algorithm. <i>ProPublica.</i> 
        ...
        <span class="reference">Lin, Z., Guan, S., Zhang, W., et al. (2024). Towards trustworthy LLMs: A review on debiasing and dehallucinating in large language models. <i>Artificial Intelligence Review, 57</i>, 243. 
          <a href="https://doi.org/10.1007/s10462-024-10896-y" target="_blank">https://doi.org/10.1007/s10462-024-10896-y</a></span><br />

        <span class="reference">Northpointe. (2015, March 13). Practitioner’s guide to COMPAS core. Electronic Privacy Information Center (EPIC). 
        ...
        <span class="reference">Patalay, P. (2023, November 21). COMPAS: Unfair algorithm? <i>Medium.</i> Retrieved from 
        ...
        <span class="reference">Staudt, S. (2025). The myth of the "revolving door:" Challenging misconceptions about recidivism. <i>Prison Policy Initiative.</i> 
          Retrieved from 
