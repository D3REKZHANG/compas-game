...
const End: React.FC<EndProps> = ({ setGamestate, trial1Score, trial2Score }) => {
  ...
  if (page === 0) {
    ...
    if (trial1Score !== null && trial2Score !== null) {
      if (trial1Score > trial2Score + 2) {
      ...
      } else if (trial2Score > trial1Score + 2) {
        ...
        comparisonText = "Your accuracy was similar between both trials, which indicates that the addition of demographic data did not affect your assessment process. The consistency in your scoring demonstrates your usage of case details beyond demographic data when performing risk assessments. If the same could be said for COMPAS, could there be something besides demographic data influencing it to make unfair decisions? The presence of bias could arise not only from explicit data, but also from how the algorithm was trained, or from real-world application methods.";
      }
    }
    content = (
      <>
    ...
    content = (
      <>
        <h2>Closing Thoughts</h2>
        <p>
          The observed data indicates that automated scoring techniques may exhibit the same biases that exist in our society. Our game required you to function as a human risk evaluator who made decisions both with and without certain demographic information available. The experience highlights key questions:
        </p>
        <ul>
          <li>
            Would a reduction in available demographic information result in tools like COMPAS making more impartial decisions?
          </li>
          <li>
