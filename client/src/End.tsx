  ...
  if (page === 0) {
    ...
    if (trial1Score !== null && trial2Score !== null) {
      if (trial1Score > trial2Score + 5) {
        ...
        comparisonText =
          "Your accuracy was similar between both trials, which indicates that the addition of demographic data did not affect your assessment process. The consistency in your scoring demonstrates your usage of case details beyond demographic data when performing risk assessments. If the same could be said for COMPAS, could there be something besides demographic data influencing it to make unfair decisions? The presence of bias could arise not only from explicit data, but also from how the algorithm was trained, or from real-world application methods.";
      }
    }
    content = (
      <>
